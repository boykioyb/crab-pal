...
const WRAPPER_COMMANDS_TURN: ActivityItem[] = [
  ...
  { id: 'wrapper-fill', type: 'tool', status: 'completed', toolName: 'browser_tool', toolInput: { command: 'fill @e5 hello@crabpal.app' }, intent: 'Wrapper: fill text field', timestamp: now - 3300 },
...
function BrowserAgentEmptyState({
  ...
  const handlePromptSelect = useCallback(async (prompt: string) => {
    ...
    const deepLinkUrl = `crabpal://${deepLinkRoute}`
...
const MOCK_BROWSER_PRESETS: Record<BrowserTabStripMockPreset, BrowserInstanceInfo[]> = {
  default: [
    ...
    {
      id: 'mock-2',
      url: 'https://linear.app/crabpal/settings/teams',
      title: 'Linear',
      favicon: null,
      isLoading: true,
      canGoBack: true,
    ...
    {
      id: 'mock-3',
      url: 'https://crabpal.bamboohr.com/employees/pto/?id=132',
      title: 'BambooHR',
      favicon: null,
      isLoading: false,
      canGoBack: true,
    ...
    {
      id: 'mock-4',
      url: 'https://github.com/boykioyb/crabpal',
      title: 'GitHub',
      favicon: null,
      isLoading: false,
      canGoBack: true,
  ...
  'long-names': [
    {
      id: 'long-1',
      url: 'https://www.notion.so/CrabPal-Multi-Session-Browser-Registry-Design-Review-Thread-2026-Q1',
      title: 'CrabPal Multi-Session Browser Registry Design Review Thread (Q1 2026)',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
    ...
    {
      id: 'long-2',
      url: 'https://linear.app/crabpal/issue/CHA-999/very-long-title-to-test-truncation-behavior-in-top-bar-badges',
  ...
  'many-running': [
    ...
    {
      id: 'run-2',
      url: 'https://linear.app/crabpal/team/CHA/active',
    ...
    {
      id: 'run-3',
      url: 'https://github.com/boykioyb/crabpal/pulls',
      title: 'GitHub PRs',
      favicon: null,
      isLoading: true,
      canGoBack: false,
    ...
    {
      id: 'run-4',
      url: 'https://crabpal.bamboohr.com/reports',
  ...
  'stress-mix': [
    ...
    {
      id: 'mix-2',
      url: 'https://linear.app/crabpal/settings/new-team',
      title: 'Add team',
      favicon: null,
      isLoading: true,
      canGoBack: true,
    ...
    },
    {
      id: 'mix-4',
      url: 'https://github.com/boykioyb/crabpal',
      title: 'CrabPal OSS Repo with a Surprisingly Long Branch and Compare View Name',
      favicon: null,
      isLoading: false,
      canGoBack: true,
      canGoForward: true,
