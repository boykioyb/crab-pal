...
> **CLI-first workflow (recommended):** Use `crabpal permission ...` commands instead of editing JSON directly.
> - `crabpal permission --help`
...
- Source: `~/.crabpal/workspaces/{slug}/sources/{source}/permissions.json`
