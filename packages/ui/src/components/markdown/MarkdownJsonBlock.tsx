 ...
 * - Uses CrabPal themes (transparent bg, CSS variable fonts)
...
export function MarkdownJsonBlock({ code, className }: MarkdownJsonBlockProps) {
  ...
  const jsonTheme = dark ? crabpalDarkTheme : crabpalLightTheme
