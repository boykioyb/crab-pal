...
const BLOCKED_ENV_VARS = [
  // CrabPal auth (set by the app itself)
  'ANTHROPIC_API_KEY',
 ...
 * Both CrabPalMcpClient (remote MCP sources) and ApiSourcePoolClient (API sources) implement this.
 */
