 ...
 *
 * Manages the step-by-step flow for setting up CrabPal:
 * 1. Welcome
...
export function OnboardingWizard({
  ...
  return (
    <div
      className={cn(
        "flex flex-col bg-[radial-gradient(circle_at_top_left,rgba(13,148,136,0.12),transparent_32%),radial-gradient(circle_at_top_right,rgba(245,158,11,0.1),transparent_24%),linear-gradient(180deg,color-mix(in_oklch,var(--background)_96%,white_4%)_0%,color-mix(in_oklch,var(--background)_92%,black_8%)_100%)]",
        className?.includes('h-full') ? "flex-1 min-h-0" : "min-h-screen",
        className
      )}
    >
      ...
      <main className="relative flex flex-1 items-center justify-center p-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,transparent_0%,rgba(255,255,255,0.18)_50%,transparent_100%)] opacity-40" />
