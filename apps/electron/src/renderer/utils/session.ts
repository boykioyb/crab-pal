...
/**
 * Compact relative-time formatter (Codex-style): "1w", "2w", "1mo", "3mo", "1y".
 * Returns an empty string for nullish timestamps.
 */
export function formatRelativeShort(lastMessageAt: number | null | undefined): string {
