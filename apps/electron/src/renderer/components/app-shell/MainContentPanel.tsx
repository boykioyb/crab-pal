...
import { MessageSquare, Globe, Zap, Bot } from 'lucide-react'
    ...
    return wrapWithStoplight(
      <Panel variant="grow" className={className}>
        <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-accent/8">
            <Globe className="h-5 w-5 text-accent/60" />
          </div>
          <div className="text-center">
            <p className="text-sm font-medium text-foreground/70">No source selected</p>
            <p className="text-xs text-muted-foreground mt-1">Select a source from the list to view details</p>
          </div>
        </div>
      </Panel>
    )
    ...
    return wrapWithStoplight(
      <Panel variant="grow" className={className}>
        <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-3">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-foreground/70">No skill selected</p>
            <p className="text-xs text-muted-foreground mt-1">Select a skill from the list to view details</p>
          </div>
        </div>
      </Panel>
    )
    ...
    return wrapWithStoplight(
      <Panel variant="grow" className={className}>
        <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-3">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-foreground/70">No automation selected</p>
            <p className="text-xs text-muted-foreground mt-1">Select an automation from the list to view details</p>
          </div>
        </div>
      </Panel>
    )
    ...
    return wrapWithStoplight(
      <Panel variant="grow" className={className}>
        <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-3">
          ...
          <div className="text-center">
            <p className="text-sm font-medium text-foreground/70">No session selected</p>
            <p className="text-xs text-muted-foreground mt-1">Select a conversation or start a new one</p>
          </div>
        </div>
      </Panel>
    )
  ...
  return wrapWithStoplight(
    <Panel variant="grow" className={className}>
      <div className="flex flex-col items-center justify-center h-full text-muted-foreground gap-3">
        ...
        <div className="text-center">
          <p className="text-sm font-medium text-foreground/70">Welcome to CrabPal</p>
          <p className="text-xs text-muted-foreground mt-1">Select a conversation to get started</p>
        </div>
      </div>
    </Panel>
  )
