...
import { getNetworkProxySettings, setNetworkProxySettings } from '@crabpal/shared/config/storage';
import type { NetworkProxySettings } from '@crabpal/shared/config/types';
