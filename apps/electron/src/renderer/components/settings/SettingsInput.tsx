    ...
    >
      ...
      <div className="flex gap-2">
        <div className={cn(
          ...
          error && 'ring-1 ring-destructive bg-destructive/5'
        )}>
          <Input
            id={id}
            type={inputType}
            ...
            onKeyDown={onKeyDown}
            className={cn(
              'bg-muted/40 border border-border/40 shadow-none focus-visible:ring-0 focus-visible:outline-none focus-visible:border-ring/50 focus-visible:bg-background transition-all duration-150',
              isPassword && 'pr-10',
  ...
  return (
    ...
    >
      ...
      <div data-layout="settings-control" className={cn(
        'ml-4 shrink-0 rounded-md transition-all duration-150',
        'has-[:focus-visible]:bg-background has-[:focus-visible]:ring-1 has-[:focus-visible]:ring-ring/50',
        error && 'ring-1 ring-destructive bg-destructive/5'
      )}>
        <Input
          ...
          placeholder={placeholder}
          disabled={disabled}
          className="w-[200px] bg-muted/40 border border-border/40 shadow-none focus-visible:ring-0 focus-visible:outline-none focus-visible:border-ring/50 focus-visible:bg-background transition-all duration-150"
        />
      </div>
    </div>
  )
    ...
    >
      ...
      <div className={cn(
        ...
        <Input
          ...
          disabled={disabled}
          onBlur={onBlur}
          className="pr-10 bg-muted/40 border border-border/40 shadow-none focus-visible:ring-0 focus-visible:outline-none focus-visible:border-ring/50 focus-visible:bg-background transition-all duration-150"
        />
        <button
          type="button"
