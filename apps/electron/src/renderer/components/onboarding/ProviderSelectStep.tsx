...
export function ProviderSelectStep({ onSelect, onSkip }: ProviderSelectStepProps) {
  return (
    <StepFormLayout
      iconElement={<CrabPalBrandMark size="lg" variant="soft" />}
      title="Welcome to CrabPal"
      ...
      <div className="space-y-3">
        {PROVIDER_OPTIONS.map((option) => (
          <button
            ...
            className={cn(
              "flex w-full items-start gap-4 rounded-lg bg-foreground-2 p-4 text-left transition-all",
