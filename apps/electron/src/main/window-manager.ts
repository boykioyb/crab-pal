...
export class WindowManager {
  ...
  private eventSink: ((channel: string, target: import('@crabpal/shared/protocol').PushTarget, ...args: any[]) => void) | null = null
   ...
   */
  setRpcEventSink(
    sink: (channel: string, target: import('@crabpal/shared/protocol').PushTarget, ...args: any[]) => void,
  ...
  getRpcEventSink(): ((channel: string, target: import('@crabpal/shared/protocol').PushTarget, ...args: any[]) => void) | null {
