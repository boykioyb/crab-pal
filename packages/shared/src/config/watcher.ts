 ...
 *
 * Watched paths:
 * - ~/.crabpal/config.json - Main app configuration
 * - ~/.crabpal/preferences.json - User preferences
 * - ~/.crabpal/theme.json - App-level theme overrides
 * - ~/.crabpal/themes/*.json - Preset theme files (app-level)
 * - ~/.crabpal/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.crabpal/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.crabpal/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.crabpal/permissions/)
