...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.crabpal/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.crabpal/docs/` | Always overwrite on launch |
| `themes/` | `~/.crabpal/themes/` | Always overwrite on launch |
| `permissions/` | `~/.crabpal/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.crabpal/tool-icons/` | Always overwrite on launch |
| `config-defaults.json` | `~/.crabpal/config-defaults.json` | Always overwrite on launch |
