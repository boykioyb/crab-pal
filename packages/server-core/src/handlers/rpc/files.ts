...
import { RPC_CHANNELS, type FileAttachment, type DirectoryListingResult } from '@crabpal/shared/protocol'
import type { StoredAttachment } from '@crabpal/core/types'
import { readFileAttachment, validateImageForClaudeAPI, IMAGE_LIMITS } from '@crabpal/shared/utils'
import { getSessionAttachmentsPath, validateSessionId } from '@crabpal/shared/sessions'
import { getWorkspaceByNameOrId } from '@crabpal/shared/config'
import { resizeImageForAPI, inspectImageBuffer } from '@crabpal/server-core/services'
import { sanitizeFilename, validateFilePath } from '@crabpal/server-core/handlers'
