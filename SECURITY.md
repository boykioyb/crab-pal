...
We take security seriously. If you discover a security vulnerability in CrabPal, please report it responsibly.
...
- The CrabPal desktop application
- The `@crabpal/*` npm packages
- Official CrabPal repositories
