  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        setToolIconsJsonPath(`${homeDir}/.crabpal/tool-icons/tool-icons.json`)
      } catch (error) {
        ...
        <ScrollArea className="h-full">
          <div className="px-5 py-7 max-w-3xl mx-auto">
            <div className="space-y-8">
              ...
              <SettingsSection
                title="Tool Icons"
                description="Icons shown next to CLI commands in chat activity. Stored in ~/.crabpal/tool-icons/."
                action={
                  toolIconsJsonPath ? (
                    <EditPopover
                      trigger={<EditButton />}
