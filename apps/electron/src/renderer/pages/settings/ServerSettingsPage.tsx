...
import type { ServerConfig, ServerStatus } from '@crabpal/shared/config/server-config'
...
export default function ServerSettingsPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title="Server" actions={<HeaderMenu route={routes.view.settings('server')} />} />
        ...
        <ScrollArea className="h-full">
          <div className="px-5 py-7 max-w-3xl mx-auto">
            <div className="space-y-8">
              ...
              {showServerDetails && (
                <SettingsSection title="Connection" description="Port, TLS certificate, and access token configuration.">
                  <SettingsCard>
                    <SettingsInputRow
                      label="Port"
                      value={form.port}
              ...
              {(isDirty || error) && (
                <SettingsCardFooter>
                  {error && (
                    <span className="text-destructive text-sm mr-auto">{error}</span>
                  )}
