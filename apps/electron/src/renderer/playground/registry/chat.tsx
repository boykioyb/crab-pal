...
import { TurnCard, type ActivityItem } from '@crabpal/ui'
...
function InputContainerPlayground({
  disabled = false,
  isProcessing = false,
  placeholder = 'Message CrabPal...',
  currentModel = 'claude-sonnet-4-6',
  permissionMode = 'ask',
  workingDirectory = '/Users/demo/projects/crabpal',
  inputMode = 'freeform',
  compactMode = false,
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/crabpal',
      },
      {
        name: 'seedRecentDirs',
