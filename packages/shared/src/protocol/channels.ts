...
export const RPC_CHANNELS = {
  ...
  legacyImport: {
    ...
    PROGRESS: 'legacyImport:progress',
  },
  logs: {
    READ: 'logs:read',
    GET_FILE_PATH: 'logs:getFilePath',
    TAIL_START: 'logs:tailStart',
    TAIL_STOP: 'logs:tailStop',
    NEW_LINES: 'logs:newLines',
    RENDERER: 'logs:renderer',
  },
} as const
