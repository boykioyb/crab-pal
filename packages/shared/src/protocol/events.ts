...
import type { ImportProgressEvent } from '../config/legacy-import'
...
export interface BroadcastEventMap {
  ...
  [RPC_CHANNELS.projects.CHANGED]: [workspaceId: string]
  ...
  [RPC_CHANNELS.legacyImport.PROGRESS]: [event: ImportProgressEvent]
