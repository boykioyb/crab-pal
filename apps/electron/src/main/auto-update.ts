 ...
 * electron-updater library. Updates are served from https://crabpal.app/electron/latest
...
import { getAppVersion } from '@crabpal/shared/version'
import {
  getDismissedUpdateVersion,
  clearDismissedUpdateVersion,
} from '@crabpal/shared/config'
import { readJsonFileSync } from '@crabpal/shared/utils/files'
