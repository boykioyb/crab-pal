 ...
 *
 * Provider mappings:
 * - Anthropic: adaptive thinking + effort levels (Opus 4.6+). On models that
 ...
 *   so CrabPal's `max` saturates there.
 */
 ...
 * `validators.ts`, and runtime validation all derive from this.
 *
...
export const THINKING_LEVELS: readonly ThinkingLevelDefinition[] = [
  ...
  { id: 'xhigh', name: 'XHigh', description: 'Extra-high reasoning (recommended for Opus 4.7 coding)' },
