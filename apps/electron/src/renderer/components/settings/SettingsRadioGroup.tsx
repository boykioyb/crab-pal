  ...
  return (
    ...
    >
      <div
        role="radiogroup"
        className={cn(
          'rounded-lg bg-background/80 backdrop-blur-sm shadow-sm overflow-hidden border border-border/40',
  ...
  return (
    <div
      className={cn(
        ...
        needsCardStyling && 'rounded-lg shadow-sm bg-background/80 backdrop-blur-sm border border-border/40',
        !disabled && 'hover:bg-foreground/[0.02]',
    ...
    >
      <button
        ...
        className={cn(
          'w-full px-4 py-3.5 text-left flex items-start gap-3 transition-colors duration-150',
