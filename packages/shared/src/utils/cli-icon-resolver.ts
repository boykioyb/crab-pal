 ...
 *
 * The mapping lives in ~/.crabpal/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.crabpal/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.crabpal/tool-icons/ containing tool-icons.json and icon files
