...
Use `browser_tool` to control built-in browser windows (Chromium) inside CrabPal.
...
- Before first browser tool usage, the agent must read this guide (`~/.crabpal/docs/browser-tools.md`).
