 ...
 * CrabPal's AgentEvent format for UI compatibility.
 *
...
/**
 * Maps Pi SDK events to AgentEvents for UI compatibility.
 *
 * Event mapping:
...
export class PiEventAdapter extends BaseEventAdapter {
  ...
  /**
   * Adapt a Pi SDK event to zero or more AgentEvents.
   */
  *adaptEvent(event: PiEvent): Generator<AgentEvent> {
    switch (event.type) {
      // ============================================================
