  ...
  if (isChatGptOAuth) {
    return (
      <StepFormLayout
        ...
        description="Use your ChatGPT subscription to power CrabPal."
        actions={
          <>
      ...
      >
        <div className="space-y-4">
          <div className="rounded-lg bg-foreground-2 p-4 text-sm text-muted-foreground">
  ...
  if (isCopilotOAuth) {
    return (
      <StepFormLayout
        ...
        description="Use your GitHub Copilot subscription to power CrabPal."
        actions={
          <>
            <BackButton onClick={onBack} disabled={status === 'validating'} />
            <ContinueButton
      ...
      >
        <div className="space-y-4">
          {copilotDeviceCode ? (
            <div className="rounded-lg bg-foreground-2 p-4 text-sm space-y-3">
            ...
            <div className="rounded-lg bg-foreground-2 p-4 text-sm text-muted-foreground text-center">
