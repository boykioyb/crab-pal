...
import { TiptapMarkdownEditor } from '@crabpal/ui'
...
const projects: PlannerProject[] = [
  ...
  { id: 'p3', name: 'CrabPal App', status: 'open', sortOrder: 3, installationHint: 'Import mounted locally', memberCount: 4 },
...
const events: PlannerTaskEvent[] = [
  ...
  { id: 'e4', taskId: 't1', type: 'task.session_snapshot_updated', at: 'Today · 18:42', actor: 'CrabPal', payloadSummary: 'Refreshed snapshot summary' },
]
