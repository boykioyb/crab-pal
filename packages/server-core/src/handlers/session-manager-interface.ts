...
import type { Workspace, WorkspaceInfo, ActiveSessionInfo } from '@crabpal/core/types'
import type { StoredAttachment, AnnotationV1 } from '@crabpal/core/types'
import type { PermissionMode } from '@crabpal/shared/agent/mode-types'
import type { ThinkingLevel } from '@crabpal/shared/agent/thinking-levels'
import type { AuthResult } from '@crabpal/shared/agent'
import type {
  Session,
  SessionStatus,
...
import type { SessionBundle, DispatchMode } from '@crabpal/shared/sessions'
...
export interface ISessionManager {
  ...
  exportRemoteSessionTransfer(
    sessionId: string,
    workspaceId: string,
  ): Promise<import('@crabpal/shared/protocol').RemoteSessionTransferPayload | null>
  ...
  importRemoteSessionTransfer(
    workspaceId: string,
    payload: import('@crabpal/shared/protocol').RemoteSessionTransferPayload,
  ): Promise<import('@crabpal/shared/protocol').ImportRemoteSessionTransferResult>
