...
import {
  ...
  type PermissionMode,
} from '@crabpal/shared/agent/modes'
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerTrigger asChild>
        <button
          ...
          className={cn(
            "h-7 pl-2 pr-2.5 text-xs font-medium rounded-lg flex items-center gap-1.5 shadow-tinted outline-none select-none shrink-0",
            style.className,
          )}
