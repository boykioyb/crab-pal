...
const TOOL_ICONS_DIR = path.join(process.env.HOME!, '.crabpal/tool-icons')
const SOURCES_DIR = path.join(
  process.env.HOME!,
  '.crabpal/workspaces/046a02d0-6521-98eb-8756-95ec4bb8c41f/sources'
)
...
// Native tool icons (from ~/.crabpal/tool-icons/)
