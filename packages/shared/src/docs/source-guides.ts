 ...
 * Guides are now served exclusively via the built-in docs MCP server
 * (tool slug: crabpal-docs).
 *
 ...
 * Use the built-in docs MCP server (`crabpal-docs`) to search for setup guides.
 *
 * Example: mcp__crabpal-docs__SearchCrabPalDocs({ query: "github source setup guide" })
 */
