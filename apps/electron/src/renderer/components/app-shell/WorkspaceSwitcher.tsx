      ...
      <DropdownMenu onOpenChange={(open) => { if (open) checkRemoteHealth() }}>
        <DropdownMenuTrigger asChild>
          {variant === 'topbar' ? (
            <button
              type="button"
              className="titlebar-no-drag ml-1 flex h-[30px] min-w-0 flex-1 items-center justify-start gap-0.5 rounded-lg border border-transparent px-3 text-[13px] text-foreground/65 transition-colors cursor-pointer hover:border-foreground/6 hover:bg-foreground/[0.04] hover:text-foreground data-[state=open]:border-foreground/8 data-[state=open]:bg-foreground/[0.06] data-[state=open]:text-foreground"
