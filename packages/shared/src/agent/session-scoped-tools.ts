 ...
 * @crabpal/session-tools-core for use with the Claude SDK.
 *
...
export interface SessionScopedToolCallbacks {
  ...
  getSessionInfoFn?: (sessionId?: string) => import('@crabpal/session-tools-core').SessionInfo | null;
  /** List sessions in the workspace with pagination. */
  listSessionsFn?: (options?: import('@crabpal/session-tools-core').ListSessionsOptions) => import('@crabpal/session-tools-core').ListSessionsResult;
  /** Resolve label display names to IDs. */
  resolveLabelsFn?: (labels: string[]) => import('@crabpal/session-tools-core').ResolvedLabelsResult;
  /** Resolve a status display name to its ID. */
  resolveStatusFn?: (status: string) => import('@crabpal/session-tools-core').ResolvedStatusResult;
}
