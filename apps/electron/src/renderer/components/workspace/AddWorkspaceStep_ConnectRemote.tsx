...
/**
 * AddWorkspaceStep_ConnectRemote - Connect to a remote CrabPal Server
 *
 * Two paths:
...
export function AddWorkspaceStep_ConnectRemote({
  ...
  const handleConnect = useCallback(async () => {
    ...
    if (!homeDir) return
    const defaultBasePath = `${homeDir}/.crabpal/workspaces`
    ...
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={isReconnectMode
          ...
          : "Connect to a remote CrabPal Server for this workspace."}
      />
