...
echo "=== Building CrabPal AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# --publish never: generate update manifest (latest-linux.yml) locally; the CI
...
# electron-builder outputs: CrabPal-x86_64.AppImage or CrabPal-aarch64.AppImage
BUILT_APPIMAGE_NAME="CrabPal-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: CrabPal-x64.AppImage, CrabPal-arm64.AppImage
APPIMAGE_NAME="CrabPal-${ARCH}.AppImage"
