 ...
 *   - `normalizeFollowUpText` (re-exported from `@crabpal/ui`) — the
 ...
 *     cause of a past bug (upstream #580) where the agent-facing path
 *     accidentally reused it.
 */

import { normalizeFollowUpText } from '@crabpal/ui'
