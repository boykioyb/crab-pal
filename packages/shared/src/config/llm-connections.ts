...
export interface LlmConnection {
  ...
  /**
   * Cached user profile fetched after OAuth completes.
   * Only populated for oauth-based Anthropic connections.
   * Best-effort — may be stale if the provider's data has changed.
   */
  profile?: {
    email?: string;
    displayName?: string;
