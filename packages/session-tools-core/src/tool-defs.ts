...
export const UpdatePreferencesSchema = z.object({
  ...
  includeCoAuthoredBy: z.boolean().optional().describe("Whether to include 'Co-Authored-By: CrabPal' trailer on git commits. Defaults to true."),
});
...
- Do NOT include any text or tool calls after SubmitPlan - they will not be executed`,
  ...
  config_validate: `Validate CrabPal configuration files.
...
Only use 'attachments' for existing file paths on disk — the tool reads them automatically.`,
  ...
  send_developer_feedback: `Send freeform feedback to the CrabPal development team.
