 ...
 * Shows both default patterns (from ~/.crabpal/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.crabpal/permissions/default.json.
...
import { type PermissionsConfigFile } from '@crabpal/shared/agent/modes'
import {
...
/**
 * Build default permissions data from ~/.crabpal/permissions/default.json.
                      ...
                      {defaultPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          ...
                          <p className="text-xs mt-1 text-foreground/40">
                            Default permissions should be at <code className="bg-foreground/5 px-1 rounded">~/.crabpal/permissions/default.json</code>
                          </p>
                        </div>
                      )}
                    </SettingsCard>
