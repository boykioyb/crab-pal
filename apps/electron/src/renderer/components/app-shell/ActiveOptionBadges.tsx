...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@crabpal/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry } from '@crabpal/shared/labels'
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        onCloseAutoFocus={(e) => {
          e.preventDefault()
          window.dispatchEvent(new CustomEvent('crabpal:focus-input', {
            detail: { sessionId }
          }))
        }}
      >
