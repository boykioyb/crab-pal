...
Shared TypeScript types and utilities for CrabPal applications.

## Installation

```bash
# In a workspace package
bun add @crabpal/core
```
...
// Import utilities
import { generateMessageId, debug } from '@crabpal/core';
```
