...
import { getDocUrl, type DocFeature } from '@crabpal/shared/docs/doc-links'
        ...
        <EmptyContent>
          {docKey && (
            <button
              ...
              className="inline-flex items-center h-7 px-3 text-xs font-medium rounded-lg bg-foreground/[0.03] border border-border/30 hover:bg-foreground/[0.06] transition-colors duration-150"
            >
              Learn more
            </button>
          )}
