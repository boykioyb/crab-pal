 ...
 * PreferencesPage
 *
 * Form-based editor for stored user preferences (~/.crabpal/preferences.json).
 * Features:
        ...
        <ScrollArea className="h-full">
          <div className="px-5 py-7 max-w-3xl mx-auto">
            <div className="space-y-8">
              ...
              <SettingsSection
                title="Basic Info"
                description="Help CrabPal personalize responses to you."
              >
                <SettingsCard divided>
                  <SettingsInput
                    label="Name"
                    description="How CrabPal should address you."
                  ...
                  <SettingsInput
                    label="Language"
                    description="Preferred language for CrabPal's responses."
              ...
              <SettingsSection
                title="Notes"
                description="Free-form context that helps CrabPal understand your preferences."
                action={
              ...
              >
                <SettingsCard divided={false}>
                  <SettingsTextarea
                    ...
                    placeholder="Any additional context you'd like CrabPal to know..."
                    rows={5}
                    inCard
                  />
                </SettingsCard>
