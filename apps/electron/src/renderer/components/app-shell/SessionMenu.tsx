...
export interface SessionMenuProps {
  ...
  onDelete: () => void
  /** Select all sessions in the same group as this session (enables multi-select). */
  onSelectGroup?: () => void
}
...
export function SessionMenu({
  ...
  return (
    <>
      ...
      {onSelectGroup && (
        <MenuItem onClick={onSelectGroup}>
          <ListChecks className="h-3.5 w-3.5" />
          <span className="flex-1">Select all in group</span>
        </MenuItem>
      )}
