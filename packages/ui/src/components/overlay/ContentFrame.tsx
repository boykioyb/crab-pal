 ...
 *          ├── Card (rounded-lg, bg-background, shadow-strong, grows to content)
  ...
  return (
    <div className="flex px-6">
      ...
      >
        ...
        <div className="flex flex-col rounded-lg overflow-hidden backdrop-blur-sm shadow-strong bg-background min-h-[320px]">
          {/* Title bar */}
