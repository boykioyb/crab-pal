 ...
 * with a ClaudeAgent instance and SDK conversation.
 */
...
export interface Session {
  ...
  projectId: string;             // Which project (inside the workspace) this session belongs to
  name?: string;                 // Optional user-defined name
  /** Optional per-session override for the working directory.
   *  When unset, the effective working directory falls back to the owning project's rootPath.
   *  See getEffectiveWorkingDirectory(session, project) in @crabpal/core. */
