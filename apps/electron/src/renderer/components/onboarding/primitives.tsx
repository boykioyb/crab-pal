...
export function StepHeader({
  ...
  return (
    <div className={cn(centered && "text-center", className)}>
      <h1 className="step-title text-[1.35rem] font-semibold tracking-[-0.03em] text-foreground">
        {title}
      </h1>
      {description && (
        <p className="step-description mt-2 max-w-sm text-sm leading-6 text-muted-foreground">
          {description}
        </p>
      )}
    </div>
...
export function StepFormLayout({
  ...
  return (
    <div className={cn(
      "flex w-[30rem] flex-col items-center rounded-lg border border-foreground/8 bg-background/90 px-7 py-8 shadow-[0_40px_120px_-56px_rgba(15,23,42,0.6)] backdrop-blur-xl",
