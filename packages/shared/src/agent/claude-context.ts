...
export type { SessionToolContext, SessionToolCallbacks } from '@crabpal/session-tools-core';
...
export interface ClaudeContextOptions {
  ...
  getSessionInfo?: (sessionId?: string) => import('@crabpal/session-tools-core').SessionInfo | null;
  listSessions?: (options?: import('@crabpal/session-tools-core').ListSessionsOptions) => import('@crabpal/session-tools-core').ListSessionsResult;
  resolveLabels?: (labels: string[]) => import('@crabpal/session-tools-core').ResolvedLabelsResult;
  resolveStatus?: (status: string) => import('@crabpal/session-tools-core').ResolvedStatusResult;
}
