 ...
 *
 * Contains the CrabPal logo dropdown with all menu functionality:
...
export function AppMenu({
  ...
  return (
    <div className="flex items-center gap-[5px] w-full">
      {/* CrabPal Logo Menu - interactive island */}
      <div className="pointer-events-auto titlebar-no-drag">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <TopBarButton aria-label="CrabPal menu">
            <CrabPalBrandMark size="sm" variant="plain" />
          </TopBarButton>
        </DropdownMenuTrigger>
