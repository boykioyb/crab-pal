#!/usr/bin/env bash
# install-server.sh — Set up the CrabPal standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  CrabPal Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  CRAB_PAL_SERVER_TOKEN=$TOKEN \\"
echo "  CRAB_PAL_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  CRAB_PAL_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  CRAB_PAL_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  CRAB_PAL_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  CRAB_PAL_RPC_HOST=0.0.0.0 \\"
echo "  CRAB_PAL_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  CRAB_PAL_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  CRAB_PAL_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  CRAB_PAL_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  CRAB_PAL_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
