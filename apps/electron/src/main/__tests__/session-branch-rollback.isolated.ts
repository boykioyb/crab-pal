...
mock.module('@crabpal/shared/agent', () => ({
...
mock.module('@crabpal/shared/agent/backend', () => ({
...
mock.module('@crabpal/shared/automations', () => ({
...
mock.module('@crabpal/shared/sessions', () => ({
  listSessions: () => [],
...
const { SessionManager } = await import('@crabpal/server-core/sessions')
