...
import { Check, Minimize2, User, Layers } from 'lucide-react'
import { Icon_Folder } from '@crabpal/ui'
import { cn } from '@/lib/utils'
import { PERMISSION_MODE_CONFIG, PERMISSION_MODE_ORDER, type PermissionMode } from '@crabpal/shared/agent/modes'

// ============================================================================
// Types
// ============================================================================

export type SlashCommandId = PermissionMode | 'compact' | 'account' | 'context'
...
const accountCommand: SlashCommand = {
  id: 'account',
  label: 'Account & Usage',
  description: 'Show account details and API usage statistics',
  icon: <User className={MENU_ICON_SIZE} />,
}

const contextCommand: SlashCommand = {
  id: 'context',
  label: 'Context Window',
  description: 'Show current context window token usage',
  icon: <Layers className={MENU_ICON_SIZE} />,
}

const featureCommands: SlashCommand[] = [compactCommand, accountCommand, contextCommand]
...
export const DEFAULT_SLASH_COMMAND_GROUPS: CommandGroup[] = [
  ...
  { id: 'commands', commands: featureCommands },
]
