...
// Uses shared components from @crabpal/ui where available
// ============================================================================
...
`} />
      ...
      {/* Section: SystemMessage (from @crabpal/ui) */}
      <section>
...
export const messagesComponents: ComponentEntry[] = [
  ...
  },
  {
    ...
    category: 'Chat Messages',
    description: 'Right-aligned user message bubble (from @crabpal/ui)',
  ...
  },
  {
    ...
    name: 'SystemMessage',
    category: 'Chat Messages',
    description: 'System/info/warning/error message (from @crabpal/ui)',
