...
#   CRAB_PAL_RPC_TLS_CERT=certs/cert.pem CRAB_PAL_RPC_TLS_KEY=certs/key.pem bun run server:dev
...
echo "  CRAB_PAL_RPC_TLS_CERT=$OUT_DIR/cert.pem CRAB_PAL_RPC_TLS_KEY=$OUT_DIR/key.pem bun run server:dev"
